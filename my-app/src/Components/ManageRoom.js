...
//     try {
//       await axios.delete("http://localhost:5000/rooms", { data: { id } });
...
//                       <img key={idx} src={image} alt={`Room ${idx}`} style={{ width: "100px", height: "100px", objectFit: "cover", marginRight: "5px" }} />
//                     ))}
//                   </div>
//                 ) : (
//                   <p className="text-danger mt-2">No image uploaded</p>
//                 )}
//               </td>
//               <td>
//                 {(room.amenities &&
